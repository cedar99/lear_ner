...
def get_argparse():
    ...
    # add soft lexicon
    model_g.add_arg("add_soft_lexicon", default=False, type=bool, help="add soft lexicon for word")
    model_g.add_arg("gaz_position_file", type=str, default=None, help="gaze vocab file path")
    model_g.add_arg("vocab_count_file", type=str, default=None, help="vocab count file path")
    model_g.add_arg("word_embedding_file", type=str, default=None, help="word embedding file file path")
